<template>
  <section>
    <BaseHero>
      <p slot="rigth" class="title">Видео</p>
    </BaseHero>
    ...
    <article class="section container is-widescreen">
      <section class="columns is-multiline">
        <div class="column is-half-tablet is-one-third-desktop is-one-quarter-widescreen is-narrow" v-for="video in videos" :key="video">
          <a @click="showModal(video)">
            <div class="card app-is-lift">
              ...
              <div class="card-content">
                <p class="title is-6">
                  <router-link to="/todo">Видео {{video}}</router-link>
                </p>
